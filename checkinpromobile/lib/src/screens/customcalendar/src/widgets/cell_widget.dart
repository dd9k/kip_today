...
class _CellWidget extends StatelessWidget {
  ...
  TextStyle _buildCellTextStyle() {
    if (isUnavailable) {
      ...
      return calendarStyle.selectedStyle;
    } else if (isOutsideMonth && isCheckin) {
      return calendarStyle.outsideCheckinStyle;
    } else if (isCheckin) {
      return calendarStyle.checkinStyle;
    } else if (isOutsideMonth && isCheckout) {
      return calendarStyle.outsideCheckoutStyle;
    } else if (isCheckout) {
      return calendarStyle.checkoutStyle;
    } else if (isOutsideMonth && isOff) {
      return calendarStyle.outsideOffStyle;
    } else if (isOff) {
      return calendarStyle.offStyle;
    } else if (isOutsideMonth && isEnweek) {
      return calendarStyle.outsideEndweekStyle;
    } else if (isEnweek) {
      return calendarStyle.endweekStyle;
