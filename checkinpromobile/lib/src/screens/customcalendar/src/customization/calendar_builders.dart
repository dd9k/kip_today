...
typedef SelectBuilder = Widget Function(
    BuildContext context, DateTime date, List events, Function onTap);

/// Builder signature for a list of event markers. Contains `date` and list of all `events` associated with that `date`.
/// Both `events` and `checkindays` and `checkoutday`params can be null.
...
class CalendarBuilders {
  ...
  /// Custom Builder for checkindays. Will overwrite `dayBuilder` on checkindays.
  final FullBuilder checkinDayBuilder;

  /// Custom Builder for checkoutdays. Will overwrite `dayBuilder` on checkoutdays.
  final FullBuilder checkoutDayBuilder;

  /// Custom Builder for checkoutdays. Will overwrite `dayBuilder` on checkoutdays.
  final FullBuilder offDayBuilder;
  final FullBuilder endweekDayBuilder;
  ...
  /// Custom Builder for checkindays outside of current month. Will overwrite `dayBuilder` on checkindays outside of current month.
  final FullBuilder outsideCheckindayDayBuilder;

  /// Custom Builder for checkoutdays outside of current month. Will overwrite `dayBuilder` on checkoutdays outside of current month.
  final FullBuilder outsideCheckoutdayDayBuilder;

  /// Custom Builder for checkoutdays outside of current month. Will overwrite `dayBuilder` on checkoutdays outside of current month.
  final FullBuilder outsideOffdayDayBuilder;
  final FullBuilder outsideEndweekDayBuilder;
  ...
  const CalendarBuilders({
    ...
    this.checkinDayBuilder,
    this.checkoutDayBuilder,
    this.offDayBuilder,
    this.endweekDayBuilder,
    this.weekendDayBuilder,
    this.outsideDayBuilder,
    this.outsideWeekendDayBuilder,
    this.outsideCheckindayDayBuilder,
    this.outsideCheckoutdayDayBuilder,
    this.outsideOffdayDayBuilder,
    this.outsideEndweekDayBuilder,
