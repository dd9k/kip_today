...
class CalendarStyle {
  ...
  /// Style of foreground Text for checkin.
  final TextStyle checkinStyle;
  final TextStyle checkoutStyle;
  final TextStyle offStyle;
  final TextStyle endweekStyle;
  ...
  /// Style of foreground Text for checkins outside of current month.
  final TextStyle outsideCheckinStyle;
  final TextStyle outsideCheckoutStyle;
  final TextStyle outsideOffStyle;
  final TextStyle outsideEndweekStyle;
  ...
  const CalendarStyle({
    ...
    this.weekdayStyle = const TextStyle(fontSize: 18),
    this.weekendStyle = const TextStyle(
        color: const Color(0xFFF44336), fontSize: 18), // Material red[500]
    this.checkinStyle = const TextStyle(color: const Color(0xFFF44336)),
    this.offStyle = const TextStyle(color: const Color(0xFFF44336)),
    this.endweekStyle = const TextStyle(color: const Color(0xFFF44336)),
    this.checkoutStyle = const TextStyle(
        color: const Color(0xFFF44336), fontSize: 18), // Material red[500]
    ...
    this.todayStyle = const TextStyle(
        color: const Color(0xFFFAFAFA), fontSize: 16.0), // Material grey[50]
    this.outsideStyle = const TextStyle(
        color: const Color(0xFF9E9E9E), fontSize: 18), // Material grey[500]
    this.outsideWeekendStyle = const TextStyle(
        color: const Color(0xFFEF9A9A), fontSize: 18), // Material red[200]
    this.outsideCheckinStyle = const TextStyle(color: const Color(0xFFEF9A9A)),
    this.outsideOffStyle = const TextStyle(color: const Color(0xFFEF9A9A)),
    this.outsideEndweekStyle =
        const TextStyle(color: const Color(0xFFEF9A9A)), // Material red[200]
    this.outsideCheckoutStyle = const TextStyle(color: const Color(0xFFEF9A9A)),
    this.unavailableStyle = const TextStyle(color: const Color(0xFFBFBFBF)),
    this.eventDayStyle = const TextStyle(),
    this.selectedColor = const Color(0xDA0099FF), // Material indigo[400]
    this.todayColor = const Color(0xFFB8DDFF), // Material indigo[200]
